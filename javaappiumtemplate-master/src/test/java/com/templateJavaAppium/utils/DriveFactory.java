...
import static com.templateJavaAppium.GlobalParameters.IsDeviceReal;
    ...
    public static void InitApp(String testName) throws IOException, InterruptedException {
        ...
        if (isAndroid)
        {
            ...
            //Se for Android, não for DeviceFarm
                ...
                //Se for com device real se não o padrão será com emulador
                if(IsDeviceReal) {
                    ...
                    //Se for Android, não for DeviceFarm e for utilizar o aplicativo já instalado usando emulador
                    if (isInstalado) {
                        DesiredCapabilities caps = new DesiredCapabilities();
                        caps.setCapability(MobileCapabilityType.PLATFORM_NAME, AndroidPlatformName);
                        caps.setCapability(MobileCapabilityType.PLATFORM_VERSION, AndroidPlatformVersion);
                    ...
                    //Se for Android, não for DeviceFarm e for utilizado um apk usando emulador
                    else {
                        DesiredCapabilities caps = new DesiredCapabilities();
                        caps.setCapability(MobileCapabilityType.PLATFORM_NAME, AndroidPlatformName);
                        caps.setCapability(MobileCapabilityType.PLATFORM_VERSION, AndroidPlatformVersion);
